...
defineEmits(['decrementar-carrito', 'incrementar-carrito', 'agregar-carrito', 'eliminar-carrito', 'vaciar-carrito'])
...
<header class="py-5 header">
        ...
        <img 
        class="header-guitarra" src="/img/header_guitarra.png" alt="imagen header">
    </header>
</template>
